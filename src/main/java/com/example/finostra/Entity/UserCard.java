...
public class UserCard {
    ...
    public static UserCard mapDTO(CardToUserDto dto, User user) {
        UserCard userCard = new UserCard();

        userCard.setCardNumber(dto.getCardNumber());
        userCard.setCardType(dto.getCardType());
        userCard.setExpirationDate(dto.getExpirationDate());
        userCard.setOwnerName(dto.getOwnerName());
        userCard.setActive(dto.isActive());
